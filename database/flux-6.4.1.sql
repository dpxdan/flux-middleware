...
DELETE FROM `flux`.`permissions_types`;

INSERT INTO `flux`.`permissions_types` (`permission_type_code`, `permission_name`, `reseller_id`, `status`) VALUES ('0', 'User', '0', '0');
...
INSERT INTO `flux`.`menu_modules` (`menu_label`, `module_name`, `module_url`, `menu_title`, `menu_image`, `menu_subtitle`,`priority`) VALUES ('Registered SIP Devices', 'sip', 'fsmonitor/sip_devices/', 'Switch', 'Live-Report.png', '0', '100.6');

INSERT INTO `flux`.`menu_modules` (`menu_label`, `module_name`, `module_url`, `menu_title`, `menu_image`, `priority`)
