...
class Addons extends MX_Controller
{
    ...
    function addons_list($type = "plugins")
    {
    ...
    public function addons_install($type = '', $module = '', $action = '', $version = "", $current_version = "")
    {
        ...
        $AddonsDataLog = array(
        	...
        	"flux_path" => $flux_path,
        	"fs_path" => $fs_path,
        	"fs_usr_path" => $fs_usr_path,
        );
        $this->flux_log->write_log('addons_install', json_encode($AddonsDataLog));
        ...
        if ($module != "" && $action != "") {
            ...
            if ($action == 'install' or $action == "update") {
                ...
                if (is_dir($addons_path . $type . "/" . $module . "/freeswitch/scripts-sbc/flux/lib/")) {
                    ...
                    $path = $addons_path . $type . "/" . $module . "/freeswitch/scripts-sbc/flux/";
                    ...
                    system("/bin/mkdir -p " . $fs_usr_path . "scripts-sbc/flux/lib/");
                    $last_line = system("/bin/cp -rf " . $addons_path . $type . "/" . $module . "/freeswitch/scripts-sbc/flux/lib/. " . $fs_usr_path . "scripts-sbc/flux/lib/.", $retval);
