				...
				<div class="col-md-12">
					<div class="card col-md-12 p-0 mb-4">
						<div class="pb-4" id="floating-label">
							...
							<div class="col-md-6 form-group float-left" id="remove_div">
																<label class="p-0 control-label"><?php echo gettext("Database Name"); ?> </label>
																<input type="text" name="dname" id="dname" value="" class="col-md-8 form-control pr-form-control form-control-lg" />
																<div>
