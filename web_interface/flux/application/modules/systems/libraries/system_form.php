...
class System_form extends common
{
    ...
    function build_admin_api_grid_buttons()
    {
        $buttons_json = json_encode(array(
            array(
                gettext("Create"),
    ...
    function build_api_list_for_admin1()
    {
        $action = 'systems/api_list_edit/';
        $action_remove = 'systems/api_remove/';
        $mode = 'popup';
        $grid_field_arr = json_encode(array(
            array(
                "<input type='checkbox' name='chkAll' class='ace checkall'/><label class='lbl'></label>",
    ...
    function build_api_list_for_admin()
    {
        $accountinfo = $this->CI->session->userdata('accountinfo');
        if ($accountinfo['type'] == - 1 || $accountinfo['type'] == 2) {
            $grid_field_arr = array(
                ...
                array(
                    ...
                    array(
                        "EDIT" => array(
                            "url" => "systems/api_list_edit/",
                            "mode" => "popup",
                            "layout" => "medium"
                        ),
                        "DELETE" => array(
                            "url" => "systems/api_remove/",
                            "mode" => "single"
                        )
                    ),
                    "false"
    ...
    function get_search_api_form()
    {
        ...
        $form[gettext('Search')] = array(
            ...
            array(
                ...
                'INPUT',
                array(
                    'name' => 'endpoint_url[endpoint_url]',
                    '',
                    'size' => '20',
                    'class' => "text field "
                ),
            ...
            array(
                ...
                'INPUT',
                array(
                    'name' => 'endpoint_auth[endpoint_auth]',
                    '',
                    'size' => '20',
                    'class' => "text field "
                ),
                ...
                'tOOL TIP',
                '1',
                'endpoint_auth[endpoint_auth-string]',
                '',
                '',
                '',
                'search_string_type',
    ...
    function get_api_form_fields($id = '', $partner_id = false)
    {
        if (! $partner_id) {
