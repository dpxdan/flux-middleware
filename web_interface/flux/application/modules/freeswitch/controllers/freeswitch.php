    ...
    function fssipdevices_json()
    {
        ...
        foreach ($query as $key => $value) {
            ...
            if ((isset($permissioninfo['freeswitch']['fssipdevices']['edit']) && $permissioninfo['freeswitch']['fssipdevices']['edit'] == 0 or $permissioninfo['login_type'] == '-1' )) {
                ...
                //$base1_url = base_url().'freeswitch/fssipdevices_phone/'.$value['id'];
                //$webrtc_permission="<span style='margin-right:8px' id='live_phone_".$value['id']."'>".$live_webrtc."</span><a href='/freeswitch/fssipdevices_phone/" . $value['id'] . "' style='cursor:pointer;color:#3b3280' rel='facebox_medium' title='".gettext('Phone')."'>" . $value['username'] . "</a>";
                //$webrtc_permission="<span style='margin-right:8px' id='live_webrtc_".$value['username']."'>".$live_webrtc."</span>".$link_webrtc."";
            }
            $current_row = array(
                $checkbox,
                $edit_permission,
