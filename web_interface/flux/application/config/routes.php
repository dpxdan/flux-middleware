...
$route['phone/(:any)'] = "phone/index/$1";

$route['proxy'] = "ApiProxy/index";
$route['proxy-post'] = "ApiProxy/forward_post";
$route['proxy-up'] = "ApiProxy/forward_post_up";
$route['proxy-cron'] = "ApiCron/GetApiData";
$route['proxy/processar/(:num)'] = 'ApiProxy/processar_cliente/$1';

$route['api-proxy/(:any)/(:any)'] = 'ApiGateway/route/$1/$2';  // Rota para encaminhar requisições com dois parâmetros
$route['api-proxy/(:any)'] = 'ApiGateway/route/$1';            // Rota para encaminhar requisições com um parâmetro
$route['api-proxy'] = 'ApiGateway/index';                      // Rota para testar se o proxy está ativo
$route['apiGateway/rotaProtegida'] = 'ApiGateway/rotaProtegida'; // Protegida por Basic Auth
