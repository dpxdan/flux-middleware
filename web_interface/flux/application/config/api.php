...
|
*/
$config['api_ip_whitelist_enabled'] = true;
...
|
*/
$config['api_ignore_http_accept'] = TRUE;
$config['api_db_user'] = $flux_config ['dbuser'];
$config['api_db_pass'] = $flux_config ['dbpass'];
$config['api_db_name'] = $flux_config ['dbname'];
$config['api_db_host'] = $flux_config ['dbhost'];
/*
|--------------------------------------------------------------------------
| api AJAX Only
|--------------------------------------------------------------------------
