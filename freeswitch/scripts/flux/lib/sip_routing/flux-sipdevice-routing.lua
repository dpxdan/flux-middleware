...
if session:ready() then
	...
	if last_disposition == "NO_USER_RESPONSE" or last_disposition == "CALL_REJECTED" or last_disposition == "NO_ANSWER" or last_disposition == "SUBSCRIBER_ABSENT"  or last_disposition == "NORMAL_TEMPORARY_FAILURE"  or last_disposition == "ALLOTTED_TIMEOUT" then
